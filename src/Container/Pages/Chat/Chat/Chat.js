...
const Chat = () => {
  ...
  return (
    <div className='show_chat'>
      <Container fluid>
        <Row className='show_chat_web'>
          <Col md={showRightProfile ? 8 : 12} className={showRightProfile ? 'make_none' : ''} style={{ transition: "all 0.3s ease" }}>
              ...
              <div className='chat_user_detail_show'>
                <div className='d-flex align-items-center' style={{ gap: "10px" }}>
                  <img src='/images/chat_img2.png' alt='' style={{ cursor: "pointer" }}
                    onClick={() => setShowRightProfile(true)} />
                  <div>
                    <h6>Summit Roy</h6>
