            ...
            <div className='material_main'>
                ...
                <div className='stockin_main mt-5'>
                    <Row className='justify-content-center'>
                        <Col md={5}>
                            <div className='stockin_box' onClick={() => navigate('/wms/stock-in/return-stock/known')}>
                                <img src={allImages.known_stock} alt='' className='black' />
                                <h6>Known Stock</h6>
                            </div>
                        </Col>
                        <Col md={5}>
                            <div className='stockin_box' onClick={() => navigate('/wms/stock-in/return-stock/unknown')}>
                                <img src={allImages.unknown_stock} alt='' className='black' />
                                <h6>Unknown Stock</h6>
                            </div>
                        </Col>
                    </Row>
